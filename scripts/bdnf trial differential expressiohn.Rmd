...
for (i in input) {
  ...
  a <- splicing_dots_tables_function(input_bc_splicing,gene_list) + annotate("text", x=0.7, y=0.1, label=i)
  plot(a)
...
sy5y_tdp_bed <- fread("~/Desktop/rbp_bed/tardbp-shsy5y-1-20210701-mh_mapped_to_genome_single_peaks.bed", 
