...
deseq2 on salmon quant + DE volcano plots
```{r}
...
list_int <- #reactome_list#
  c("TARDBP", "STMN2", "UNC13A", "UNC13B") #,
              #"PFKP", "AGRN", "RAP1GAP", 
...
write.table(big_data_chx, "~/Desktop/ds_chx.csv", sep = ",", row.names = F)
#slope plot
...
#ggtranscript visualization - hold for now
```{r}
...
gene_list <- panel31$gene
#gene_list <- c("CYFIP2", "SYNE1") ##to be run on chx
for (i in gene_list) {
